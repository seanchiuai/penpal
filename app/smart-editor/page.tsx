...
export default function SmartEditorDashboard() {
  ...
  const handleCreateDocument = async () => {
    ...
    try {
      ...
      setNewDocTitle("");
      router.push(`/smart-editor/${docId}`);
    } catch (error) {
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-6xl">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-4xl font-bold mb-2">Smart Editor</h1>
        ...
        <Card className="py-12">
          <CardContent className="flex flex-col items-center justify-center text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Create your first document to start using the Smart Editor
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {documents.map((doc) => (
            <Card
              ...
              onClick={() => router.push(`/smart-editor/${doc._id}`)}
            >
              <CardHeader>
